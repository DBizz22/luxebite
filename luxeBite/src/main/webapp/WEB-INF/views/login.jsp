<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
        ...
        <head>
            ...
            <title>Login - LuxeBite</title>
            <script src="https://cdn.tailwindcss.com"></script>
            <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet" />
            <style>
                .bg-food {
                    background: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.85)), url('https://images.unsplash.com/photo-1541592106381-b31e9678c0e7?q=80&w=2000') center/cover;
                }
            </style>
        </head>
        ...
        <body class="bg-gray-900 min-h-screen flex items-center justify-center py-12 px-4">
            <div class="max-w-md w-full">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-400 mt-2">Welcome back to premium dining</p>
                </div>

                <div class="bg-gray-800/90 backdrop-blur-lg p-10 rounded-2xl shadow-2xl border border-amber-900/30">
                    <h2 class="text-2xl font-semibold text-white text-center mb-8">Sign In</h2>
                    ...
                    <form action="${pageContext.request.contextPath}/login" method="POST" class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="email" required placeholder="you@example.com"
                                class="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-amber-500 focus:border-transparent">
                        </div>
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <a href="#" class="text-amber-400 hover:text-amber-300">Forgot password?</a>
                        </div>
                    ...
                    <p class="text-center text-gray-400 mt-6 text-sm">
                        New here? <a href="${pageContext.request.contextPath}/register"
                            class="text-amber-400 hover:text-amber-300 font-medium">Create an account</a>
                    </p>
                </div>
            </div>
